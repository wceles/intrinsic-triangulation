# Testing Supporting HalfEdge Data Structure
# Waldemar Celes
...
def initialize (win, filename):
  ...
  global E, T, H, L, S, A, PROP, PROP_E, colorscale, colorcode
  ...
  DS = [E,H,T,L,S,A,PROP,PROP_E,colormap,colorscale,wireframe,colorcode]
  ...
  shader_intrinsic.AttachFragmentShader("shader/fragment_intrinsic.glsl")
